<script lang="ts">
  ...
  const PLAN: Room[] = [
    ...
    { id: "eben", label: "Eben", left: 59.1, top: 28.4, w: 16.1, h: 23, lights: [{ id: "light.eben_room_lamp", label: "Eben Lamp", icon: "💡" }] },
    ...
    { id: "dining", label: "Dining", left: 25.3, top: 51.4, w: 15.6, h: 33.8, lights: [{ id: "light.dining_room_lamp", label: "Dining", icon: "🍽️" }] },
    ...
    { id: "bed3", label: "Bed 3", left: 68.3, top: 57.4, w: 16.7, h: 27.7, lights: [] },
