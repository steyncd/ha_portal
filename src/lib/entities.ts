...
export const E = {
  ...
  energyBanner: "sensor.energy_action_banner",
  selfSufficiency: "sensor.self_sufficiency_today",
  solarSaved: "sensor.solar_saved_today",
  consumptionExpected: "sensor.consumption_expected_today",
  consumptionVsExpected: "sensor.consumption_vs_expected",
  mpptHealth: "sensor.mppt_string_health",
  batteryValueNow: "sensor.battery_value_now",
  batteryTou: "sensor.battery_tou_status",
  solarSurplusWindow: "binary_sensor.solar_surplus_window_open",
  boreholeEff: "sensor.borehole_efficiency_today",
  boreholeEff30d: "sensor.borehole_efficiency_30d",
  batteryCellSpread: "sensor.battery_cell_temp_spread",
  systemHealthIssues: "sensor.system_health_issues",
  frigateStalled: "binary_sensor.frigate_detection_stalled",
...
export const ROOMS: Room[] = [
  ...
  { id: "sensor.study_bt_device_scanner_desk_temperature", label: "Desk", humidity: "sensor.study_bt_device_scanner_desk_humidity" },
